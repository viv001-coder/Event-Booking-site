...
const users = [
    { name: 'Admin User', email: 'admin@eventa.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventa.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventa.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventa.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventa.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventa.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventa.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventa.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventa.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventa.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventa.com');
        console.log('User Email:  user@eventa.com');
